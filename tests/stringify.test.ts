...
describe("stringify", () => {
  ...
  it("stringify toml", () => {
    ...
    expect(stringify(toml, opts)).toStrictEqual(dedent`
            ...
            k = "2023-01-01"
        `)
    expect(stringify(toml, { inline: true, ...opts })).toStrictEqual(dedent`
            "" = 1
            "🀄" = inf
            "$" = nan
            0-1 = -18
            ...
            da = "1979-05-27T00:32:00.999999-07:00"
            date = 1970-01-01T00:00:00Z
            e = { d = { h = "2023-01-01T00:00:01-07:00", i = "2023-01-01T00:00:01Z", j = "2023-01-01T00:00:01", k = "2023-01-01" }, f = 1 }
        `)
  })
